...
<form name='reg' method ='post' action="teacher_reg1.jsp" onsubmit='return validate()'>
<table background='b3.jpg'align="center" width=650 style='border:1px solid black;border-radius:8px;box-shadow:8px 8px 8px #888888;'>
<tr>
