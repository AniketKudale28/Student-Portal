...
<%
	...
	ResultSet rs= s.executeQuery("select loginid,name,address,gender,phone,email,qualification from teacher");
%>
<br>
...
<tr>
	...
	<td><center>
	<b>
	<a href="delete_faculty1.jsp?tid=<%=rs.getString(1)%>">Delete</a>
	</b></center>
	</td>
</tr>
<%	}	
